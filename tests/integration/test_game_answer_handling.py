...
def test_correct_answer_returns_to_board_logs_and_adds_score(game_with_players):
    game = game_with_players
    question = game.current_round.get_question(0, 0)
...
def test_stumped_closes_responses_and_enables_return_to_board(game_with_players):
    game = game_with_players
    question = game.current_round.get_question(0, 0)
    game.load_question(question)
    game.open_responses()
